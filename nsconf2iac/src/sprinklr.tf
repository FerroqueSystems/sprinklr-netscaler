resource "citrixadc_nsconfig_update" "nsconfig_84984476" {
  ipaddress = "10.0.1.9"
  netmask = "255.255.255.0"
}
resource "citrixadc_nsconfig_update" "nsconfig_74112115" {
  nsvlan = "10"
  ifnum = [
    "0/1"
  ]
...
resource "citrixadc_nsfeature" "nsfeature_90481533" {
  wl = "true"
  sp = "true"
  lb = "true"
  ssl = "true"
...
resource "citrixadc_nsmode" "nsmode_13972380" {
  mbf = "true"
  usnip = "true"
  pmtud = "true"
}
...
resource "citrixadc_rsskeytype" "rsskeytype_49233094" {
  rsstype = "ASYMMETRIC"
}
resource "citrixadc_lacp" "lacp_94823468" {
  syspriority = "32768"
}
resource "citrixadc_nshostname" "nshostname_12298100" {
...
resource "citrixadc_sslparameter" "sslparameter_34580858" {
...
resource "citrixadc_nsencryptionparams" "nsencryptionparams_73248912" {
  method = "AES256"
...
resource "citrixadc_cmpparameter" "cmpparameter_22928537" {
  cmpbypasspct = "98"
}
...
resource "citrixadc_aaaparameter" "aaaparameter_44647285" {
...
resource "citrixadc_appflowparam" "appflowparam_31596512" {
...
resource "citrixadc_botsettings" "botsettings_9186208" {
...
resource "citrixadc_dnsnameserver" "dnsnameserver_20235221" {
  dnsvservername = "azurelbdnsvserver"
}
resource "citrixadc_nsdiameter" "nsdiameter_22951716" {
  identity = "netscaler.com"
  realm = "com"
}
resource "citrixadc_subscribergxinterface" "subscribergxinterface_42922945" {
  pcrfrealm = "pcrf.com"
  servicepathavp = [
    "262099"
  ]
...
resource "citrixadc_auditnslogparams" "auditnslogparams_63121036" {
  loglevel = [
    "DEBUG"
  ]
  tcp = "ALL"
...
resource "citrixadc_ip6tunnelparam" "ip6tunnelparam_93867879" {
  srcip = "::"
}
resource "citrixadc_ptp" "ptp_44449448" {
  state = "ENABLE"
}
resource "citrixadc_nscqaparam" "nscqaparam_65343494" {
  lr1probthresh = "0.0"
  lr2probthresh = "0.0"
}
